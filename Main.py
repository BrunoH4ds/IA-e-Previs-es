...
import os
print(os.path.isfile(r"IA e Previsoes\clientes.csv"))


tabela = pd.read_csv(r"IA e Previsoes\clientes.csv") # importa a base de dados
display(tabela)
...
novos_clientes = pd.read_csv(r"IA e Previsoes\novos_clientes.csv")
